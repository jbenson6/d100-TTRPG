...
echo.
echo ========================================
echo   Publishing d100 TTRPG v1.0.2
echo ========================================
echo.
...
powershell -NoProfile -Command "Compress-Archive -Path '.\d100 TTRPG\bin\Release\net10.0\win-x64\publish\*' -DestinationPath '.\d100 TTRPG\bin\Release\net10.0\win-x64\d100-TTRPG-1.0.2.zip' -Force"
if errorlevel 1 goto :error

echo.
echo [5/6] Checking GitHub release...

gh release view v1.0.2 --repo jbenson6/d100-TTRPG >nul 2>&1

if errorlevel 1 (
    echo Release v1.0.2 does not exist.
    echo Creating new GitHub release...

    gh release create v1.0.2 ".\d100 TTRPG\bin\Release\net10.0\win-x64\d100-TTRPG-1.0.2.zip" --repo jbenson6/d100-TTRPG --title "v1.0.2" --notes "Initial release."
...
gh release delete-asset v1.0.2 d100-TTRPG-1.0.2.zip --repo jbenson6/d100-TTRPG -y >nul 2>&1

echo.
echo [6/6] Uploading new GitHub asset...

gh release upload v1.0.2 ".\d100 TTRPG\bin\Release\net10.0\win-x64\d100-TTRPG-1.0.2.zip" --repo jbenson6/d100-TTRPG
...
echo.
echo ========================================
echo   v1.0.2 published successfully!
echo ========================================
echo.
echo GitHub release:
echo https://github.com/jbenson6/d100-TTRPG/releases/tag/v1.0.2
echo.
pause
exit /b 0
